...
# Database: efg
# Generation Time: 2011-01-28 13:19:24 +0800
# ************************************************************
...
CREATE TABLE `nodes` (
  ...
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='記錄雜項資料';
...
VALUES
	...
	(27,'聯絡我們',NULL,'33',NULL,'zhtw',NULL,NULL),
	(28,'Contact Us',NULL,'33',NULL,'en',NULL,NULL);
...
VALUES
	...
	(33,'聯絡我們','summary',NULL,NULL,0,NULL);
