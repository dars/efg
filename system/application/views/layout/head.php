...
<div class="flash-menu">
	...
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
 		...
 		width="980" height="97">
		<param name="movie" value="<?=site_url('public/swf/'.$this->lang->line('flash_menu_url').'?base_url='.base_url())?>" /> 
		<param name="quality" value="high" />
		<param name="menu" value="false" />
		<!--[if !IE]> <-->
		<object data="<?=site_url('public/swf/'.$this->lang->line('flash_menu_url').'?base_url='.base_url())?>"
